...
function changeBoxColor(e) {
   ...
   if (currentTool === "colorBrush") {
      if (
         randomColorOption.checked === true &&
         randomShadesOption.checked === true
      ) {
         this.style.backgroundColor = `rgb(${randomR}, ${randomG}, ${randomB})`;
         this.style.opacity = `${randomOpacity}`;
      } else if (
         randomColorOption.checked === true &&
         randomShadesOption.checked === false
      ) {
         this.style.backgroundColor = `rgb(${randomR}, ${randomG}, ${randomB})`;
         this.style.opacity = `1`;
      } else if (
         randomColorOption.checked === false &&
         randomShadesOption.checked === true
      ) {
...
function stopPainting() {
   const boxes = document.querySelectorAll(".box");
   boxes.forEach((box) =>
      box.removeEventListener("mouseenter", changeBoxColor)
   );
}
...
//tools images
document.querySelector("#leftBtn1").style.backgroundImage =
   "url(./images/brush.png)";
document.querySelector("#leftBtn1 .tooltiptext").textContent = "Brush";
document.querySelector("#leftBtn2").style.backgroundImage =
   "url(./images/line.png)";
document.querySelector("#leftBtn2 .tooltiptext").textContent = "Line";
document.querySelector("#leftBtn3").style.backgroundImage =
   "url(./images/rectangle.png)";
document.querySelector("#leftBtn3 .tooltiptext").textContent = "Rectangle";
document.querySelector("#leftBtn4").style.backgroundImage =
   "url(./images/circle.png)";
document.querySelector("#leftBtn4 .tooltiptext").textContent = "Circle";
document.querySelector("#leftBtn5").style.backgroundImage =
   "url(./images/ngon.png)";
document.querySelector("#leftBtn5 .tooltiptext").textContent = "Ngon";
document.querySelector("#leftBtn6").style.backgroundImage =
   "url(./images/arc.png)";
document.querySelector("#leftBtn6 .tooltiptext").textContent = "Arc";

document.querySelector("#rightBtn1").style.backgroundImage =
   "url(./images/erase.png)";
